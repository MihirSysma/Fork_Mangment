...
import static com.forkmang.fragment.PickupSelect_Food_Fragment.instance_pickup;
...
public class PickupListingAdapter extends RecyclerView.Adapter<PickupListingAdapter.CartProductItemHolder> {
    Context ctx;
    ArrayList<CartBooking> cartBookingArrayList;
    Activity activity;
    StorePrefrence storePrefrence;

    public PickupListingAdapter(Context ctx, ArrayList<CartBooking> cartBookingArrayList) {
        this.ctx = ctx;
        this.cartBookingArrayList = cartBookingArrayList;
        storePrefrence=new StorePrefrence(ctx);
    }

    public PickupListingAdapter(Activity activity) {
        ...
        public CartProductItemHolder(@NonNull View itemView) {
            ...
            minus_btn.setOnClickListener(v -> {
                ...
                if (Utils.isNetworkAvailable(ctx)) {
                    ...
                    instance_pickup.callApi_addqty(cart_item_id, String.valueOf(qty_update));
                }
                else{
            ...
            img_del.setOnClickListener(v -> {
                ...
                tvremove.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        dialog.dismiss();
                        if (Utils.isNetworkAvailable(ctx)) {
                            instance_pickup.callApi_removeitemcart(cart_item_id);
                        }
                        else{
                            Toast.makeText(ctx, Constant.NETWORKEROORMSG, Toast.LENGTH_SHORT).show();
                        }
