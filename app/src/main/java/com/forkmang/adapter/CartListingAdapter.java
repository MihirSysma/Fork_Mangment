...
import static com.forkmang.fragment.Select_Food_Fragment.instance;
...
public class CartListingAdapter extends RecyclerView.Adapter<CartListingAdapter.CartProductItemHolder> {
    Context ctx;
    ArrayList<CartBooking> cartBookingArrayList;
    Activity activity;
    StorePrefrence storePrefrence;

    public CartListingAdapter(Context ctx, ArrayList<CartBooking> cartBookingArrayList) {
        this.ctx = ctx;
        this.cartBookingArrayList = cartBookingArrayList;
        storePrefrence=new StorePrefrence(ctx);
    }

    public CartListingAdapter(Activity activity) {
