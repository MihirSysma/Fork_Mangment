...
class Walkin_detail_Fragment : FragmentActivity() {
    //Walkin_detail_Fragment instance;
    var relative_bottom: RelativeLayout? = null
    var ctx: Context = this@Walkin_detail_Fragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val personAdapter = SpinnnerAdapter(applicationContext, person_arr)
        ...
        val ocassionAdapter = SpinnnerAdapter_ocassion(applicationContext, occasion_arr)
    ...
    companion object {
        fun newInstance(): Walkin_detail_Fragment {
            return Walkin_detail_Fragment()
        }
    }
}